...
#' @note Be aware that if 'from' and 'to' have consequent size, output will require much memory
#' space.
#' @examples
...
get_multi_paths <- function(Graph, from, to, keep = NULL, long = FALSE) {
    ...
    res <- Dijkstra_multi_path(
        Graph$data[, 1], Graph$data[, 2], Graph$data[, 3], Graph$nbnode,
